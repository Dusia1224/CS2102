...
//Subtasks for Problem 1 Method1.
/*
1)loop through the list of PHRs  

2)get each elements' weight and height 

3)calculate the BMI using the formula provided

4)create four Linked Lists that hold names of four types of patient records

5) check the bmi of each element and if the bmi is between specific range of values 
segregate to appropriate group (underweight, healthy, overweight, obese)

6) create an instance of BMISummary to hold the four classification lists to return
*/